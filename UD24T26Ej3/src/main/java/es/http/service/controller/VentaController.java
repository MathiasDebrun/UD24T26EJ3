...
//		System.out.println("Venta XID: "+Venta_xid);
	...
	public Venta actualizarVenta(@PathVariable(name="id")int id,@RequestBody Venta Venta) {
		...
		Venta_seleccionado.setCodigoCajero(Venta.getCodigoCajero());
		Venta_seleccionado.setCodigoMaquina(Venta.getCodigoMaquina());
		Venta_seleccionado.setCodigoProducto(Venta.getCodigoProducto());
